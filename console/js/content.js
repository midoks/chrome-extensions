...
//
 ...
 var vconsoleURL = chrome.extension.getURL('vconsole.min.js');

 

 $(document.body).append("<script src='http://wechatfe.github.io/vconsole/lib/vconsole.min.js?v=3.3.0'></script>");
// $(document.body).append("<script src='" + vconsoleURL + "'></script>");
$(document.body).append("<script>"+"window.vConsole = new window.VConsole();"+"</script>");
